...
// root [1] .L Run_BadChannel.C++
// root [2] Run_BadChannel(1,"LHC15o","Train_771","INT7",244918,"","GloballyGood.txt") //for merging
...
// root [2] GetBestPeriodSplitting("LHC15o","Train_771",105,3)
// root [2] Test_OADB("LHC15o",Int_t trainNo=603,0,Int_t runNumber=244411)
...
//
//________________________________________________________________________
void Test_MaskedAmplitude(TString period="LHC15n",Int_t trainNo=603,Int_t version=5)
{
	gROOT->ProcessLine("gErrorIgnoreLevel = kWarning;"); //..to supress a lot of standard output
	gStyle->SetOptStat(0); //..Do not plot stat boxes
	...
	TString pathA        = Form("/Users/Eliane/Software/BadChannelAnalysis/AnalysisOutput/%s/Train_%i/Version%i",period.Data(),trainNo,version);
	...
	TString pathB        = Form("/Users/Eliane/Software/BadChannelAnalysis/AnalysisOutput/%s/Train_%i/Version%i",period.Data(),trainNo,version+1);
	...
	TString pathC        = Form("/Users/Eliane/Software/BadChannelAnalysis/AnalysisOutput/%s/Train_%i/Version%i",period.Data(),trainNo,version+2);
	...
	TString pathD        = Form("/Users/Eliane/Software/BadChannelAnalysis/AnalysisOutput/%s/Train_%i/Version%i",period.Data(),trainNo,version+3);
	...
	TString pathRbR        = Form("/Users/Eliane/Software/BadChannelAnalysis/AnalysisOutput/%s/Train_%i/RunByRunSummary105",period.Data(),trainNo);
...
//		if(hNEvent[usedRuns]->Integral()>1000000)continue;
	...
	for(Int_t ic = 0; ic < noOfCells; ic++)
	{
		...
		if(ic==badcellsBlock4.at(0))integralBlock4=1;
...
//________________________________________________________________________
void GetBestPeriodSplitting(TString period = "LHC15o", TString train = "Train_641",Int_t Nruns=105, Int_t noOfSplits=4)
{
	...
	//.......................................
	TString fileName = Form("AnalysisOutput/%s/%s/RunByRunSummary%i/%s_Results.root",period.Data(),train.Data(),Nruns,runList.Data());
